sap.ui.jsview("releasemanagementcockpit.view.RetiredCD", {

	/** Specifies the Controller belonging to this View. 
	 * In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	 * @memberOf releasemanagementcockpit.view.RetiredCD
	 */
	getControllerName: function () {
		return "releasemanagementcockpit.controller.RetiredCD";
	},
	...
	createContent: function (oController) {
		...
		var oTemplateTable = new sap.ui.table.Table({
			...
			columns: [
				...
				new sap.ui.table.Column({
					id: "retiredCDTable-RetrofitStatus",
				...
				new sap.ui.table.Column({
					id: "retiredCDTable-RetrofitStatusText",
				...
				new sap.ui.table.Column({
					id: "retiredCDTable-PrdImpTimestamp",
		...
		var oSmartTable = new sap.ui.comp.smarttable.SmartTable("retiredCDTable", {
			...
			persistencyKey: "RetiredChangeDocKey",
			items: [oTemplateTable],
			smartVariant: oSmartVariantManagement
		});

		var oTemplate = new sap.ui.table.RowAction("retiredChangeDocTableRowAction", {
			items: [
		...
		var oMessageStrip = new sap.m.MessageStrip("messageStrip", {
			text: "{i18n>sync_back}", //'Running synchronization in background. Choose "Refresh" to see results.',
			showIcon: true,
			visible: false
		});
		var oPage = new sap.m.Page({
			title: "{i18n>release_ex}", //"Release Exceptions",
			showHeader: false,
