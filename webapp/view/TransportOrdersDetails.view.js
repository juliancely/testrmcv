sap.ui.jsview("releasemanagementcockpit.view.TransportOrdersDetails", {
	...
	getControllerName: function() {
		return "releasemanagementcockpit.controller.TransportOrdersDetails";
	},
	...
	createContent: function(oController) {
		var objectIdCustomData = {
			...
			"sortProperty": "TrorderNumber",   // All these lines are commented to improve the behaviour of sort in tree tables
		...
		var oTemplateTable = new sap.ui.table.TreeTable({
			...
			columns: [
				new sap.ui.table.Column("TrorderNumber", {
				...
				new sap.ui.table.Column("TrText", {
				...
				new sap.ui.table.Column("trFunction", {
				...
				new sap.ui.table.Column("trStatus", {
				...
				new sap.ui.table.Column("ImportedIn", {
				...
				new sap.ui.table.Column("PrdImpTimestamp", {
				...
				new sap.ui.table.Column("retStatus", {
				...
				new sap.ui.table.Column({
				    id: "transportOrders-RetrofitStatusText",
				...
				new sap.ui.table.Column({
				    id: "transportOrders-RetrofitTROrderDev",
				...
				new sap.ui.table.Column("RespUser", {
				...
				new sap.ui.table.Column("CreatedDate", {
				...
				new sap.ui.table.Column("CreatedTime", {
				...
				new sap.ui.table.Column("ReleasedDate", {
				...
				new sap.ui.table.Column("ReleasedTime", {
		...
		var text = new sap.m.Text("urlParams");
		var oSmartTable = new sap.ui.comp.smarttable.SmartTable("transportOrders", {
		...
		var oMessageStrip = new sap.m.MessageStrip("messageStripOT",{
		...
		var header = [
		    new sap.m.Button("expandCollapseButton",{
    			text: "{i18n>Expand}", //'Expand/Collapse',
    			icon: "sap-icon://navigation-down-arrow",
    			press: oController.onExpandCollapse,
    			visible: "{= ${UserModel>/showToCs} === 'X' ? true : false}"
    		}),
		    new sap.m.Button({
    			text: "{i18n>refresh}", //'Refresh',
    			icon: "sap-icon://refresh",
    			press: oController.refresh
    		})
		];

		return new sap.m.Page("transportOrdersPage", {
			headerContent: header,
			showNavButton: true,
			navButtonText: "Back",
			title: "{i18n>transport_requests}",//"Transport Orders",
			content: [oMessageStrip,oSmartTable],
			navButtonPress: oController.backToPreviousPage
		});
	}
